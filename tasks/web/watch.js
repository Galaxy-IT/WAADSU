module.exports = function () {
  $.gulp.task('watch', function () {
    ...
    $.gulp.watch('./static/stylus/**/*.{styl,stylus}', $.gulp.series('styles:dev'));
    ...
    $.gulp.watch(['./static/img/general/**/*.{png,jpg,gif,JPG,PNG,GIF}',
      './static/img/content/**/*.{png,jpg,gif,JPG,PNG,GIF}'], $.gulp.series('img:dev'));
    $.gulp.watch(['./static/img/general/**/*.{png,jpg,gif,JPG,PNG,GIF}',
      './static/img/content/**/*.{png,jpg,gif,JPG}'], $.gulp.series('img:webp'));
